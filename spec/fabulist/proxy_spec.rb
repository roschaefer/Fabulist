...
describe Fabulist::Proxy do
  context ".new" do
     context "defines every key value pair as a recognition method" do
       it "for Strings" do
         user = "A User"
         decorator = Fabulist::Proxy.new(user, :called => "Joe")
      ...
      it "for Times" do
        match = "A Match"
        decorator = Fabulist::Proxy.new(match, :taking_place => Time.parse("01.01.2020"))
      ...
      it "even multiple times" do
        ...
        decorator = Fabulist::Proxy.new(match, :participants => [user1, user2], :taking_place => Time.parse("01.01.2020"))
        decorator.taking_place(Time.parse("1.1.2020")).should be_true
        decorator.taking_place(Time.parse("1.2.2020")).should be_false
